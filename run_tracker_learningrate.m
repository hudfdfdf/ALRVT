...
%
% 
function [results] =run_tracker_learningrate(video, show_visualization, show_plots)
...
padding = struct('generic', 1.95, 'large', 1, 'height', 0.8);
...
switch video
    case 'choose',
        ...
        if ~isempty(video)
            ...
            [results] = run_tracker_learningrate(video, show_visualization, show_plots);            
    ...
    case 'all',
        ...
        parfor k = 1:numel(videos)
            ...
            [all_precisions(k), all_fps(k)] = run_tracker_learningrate(videos{k}, show_visualization, show_plots,st,md);
        end
    ...
    otherwise
        ...
        [positions, time] = tracker_ensemble_learningrate(video_path, img_files, pos, target_sz, ...
