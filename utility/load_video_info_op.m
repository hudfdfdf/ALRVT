function [img_files, pos, target_sz, ground_truth, video_path,ground_truth1] = load_video_info(base_path, video)
%LOAD_VIDEO_INFO
...
%   http://www.isr.uc.pt/~henriques/
    ...
    ground_truth1 = [ground_truth(:,[2,1]) + (ground_truth(:,[4,3]) - 1) / 2 , ground_truth(:,[4,3])];
	fclose(f);
